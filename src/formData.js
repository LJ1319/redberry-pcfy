export const formData = () => {
  ...
  formData.append("phone_number", JSON.parse(localStorage.getItem("employee_email")));
  formData.append("email", JSON.parse(localStorage.getItem("employee_phone")));
  ...
  formData.append("laptop_cpu", JSON.parse(localStorage.getItem("cpu")));
  ...
  formData.append("laptop_condition", JSON.parse(localStorage.getItem("laptop_condition")));
